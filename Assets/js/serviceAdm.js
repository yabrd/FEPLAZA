...
function editService(serviceId) {
    ...
    const url = `http://localhost/PlazaBarbershop/API/api.php/layanan/${serviceId}`;
    fetch(url)
        .then(response => response.json())
        .then(service => {
...
function simpanDataGambar() {
    ...
    xhr.open("POST", "http://localhost/PlazaBarbershop/API/api.php/gambarlayanan", true);
    xhr.onload = function() {
        if (xhr.status === 200) {
...
function editsimpanDataGambar(id) {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "http://localhost/PlazaBarbershop/API/api.php/gambarlayanan/"+id, true);
    xhr.onload = function() {
        if (xhr.status === 200) {
...
function simpanDataPelayanan() {
    ...
    xhr.open("POST", "http://localhost/PlazaBarbershop/API/api.php/layanan", true);
...
function deleteService(ServiceId) {
    if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open("DELETE", "http://localhost/PlazaBarbershop/API/api.php/layanan/" + ServiceId, true);
        xhr.setRequestHeader("Content-Type", "application/json");
        xhr.onload = function() {
            if (xhr.status === 200) {
...
function saveEditedService() {
    ...
    xhr.open("PUT", "http://localhost/PlazaBarbershop/API/api.php/layanan/"+id, true);
